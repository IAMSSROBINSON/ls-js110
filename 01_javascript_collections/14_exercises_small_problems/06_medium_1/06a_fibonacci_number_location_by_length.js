function findFibonacciIndexByLength(length) {
  let previousFibonacciNumber = 1n;
  let currentFibonacciNumber = 1n;
  let fibonacciIndex = 2n;

  while (true) {
    let nextFibonacciNumber = previousFibonacciNumber + currentFibonacciNumber;
    let stringFibonacci = String(currentFibonacciNumber).length;

    if (stringFibonacci >= length) {
      break;
    }
