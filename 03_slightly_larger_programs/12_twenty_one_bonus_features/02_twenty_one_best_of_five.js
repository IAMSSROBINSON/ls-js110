...
function increaseWinnerScore (winner, userScoreManager, dealerScoreManager) {
  if (winner === USER_NAME) {
    userScoreManager.increaseScore();
  } else  if (winner === DEALER_NAME) {
    dealerScoreManager.increaseScore();
  }
}

function isGrandWinner (userScoreManager, dealerScoreManager) {
  return userScoreManager.getScore() === GRAND_WINNING_SCORE ||
  dealerScoreManager.getScore() === GRAND_WINNING_SCORE;
}

function displayScores (userScoreManager, dealerScoreManager) {
  console.log(`\nSCORES:`);
  console.log(USER_NAME, userScoreManager.getScore());
  console.log(DEALER_NAME, dealerScoreManager.getScore());
}

function resetScores (userScoreManager, dealerScoreManager) {
  userScoreManager.resetScore();
  dealerScoreManager.resetScore();
}
